...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View drawer =  inflater.inflate(R.layout.fragment_profile, container, false);
        showToolbar("", false, drawer);

        // Desde aqui los componentes de RecyvlerView para reutilizar en los demas fragments
        RecyclerView picturesRecycler = (RecyclerView) drawer.findViewById(R.id.pictureProfileRecycler);
